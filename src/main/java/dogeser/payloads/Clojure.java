...
@dogeser.payloads.annotation.Authors({ Authors.JACKOFMOSTTRADES })
public class Clojure extends dogeser.payloads.util.PayloadRunner implements ObjectPayload<Map<?, ?>> {
